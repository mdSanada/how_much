...
part of 'materials.viewmodel.dart';
...
mixin _$MaterialsViewModel on MaterialsViewModelBase, Store {
  late final _$materialsAtom =
      Atom(name: 'MaterialsViewModelBase.materials', context: context);
  ...
  late final _$getMaterialsAsyncAction =
      AsyncAction('MaterialsViewModelBase.getMaterials', context: context);
